(function (){
  ...
  // GENERATED from dataset.yaml at Thu Nov 19 15:31:37 AEDT 2020 by rowena

  // Snapshot from package.json
  var package_info = {"name":"woothee","version":"1.11.0","description":"User-Agent string parser (js implementation)","main":"./release/woothee","devDependencies":{"chai":">= 1.3.0","js-yaml":">= 1.0.3","mocha":"^6.0.0","serialize-to-js":"^3.1.1","should":"~1.2.2"},"scripts":{"test":"make test"},"repository":{"type":"git","url":"https://github.com/woothee/woothee-js"},"author":"tagomoris","license":"Apache-2.0"};
  ...
  (function(){
    ...
    var challengeCrawlers = exports.challengeCrawlers = function(ua, result) {
      ...
      if (ua.indexOf('DeepCrawl') >= 0) {
        updateMap(result, dataset.get('DeepCrawl'));
        return true;
      }
      return false;
    };
